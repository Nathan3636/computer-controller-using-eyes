...
def main():
    ...
    text = speech_to_text()
    if wake_up(text, name):
        res = "Hello I am Bot, what can I do for you?"
    elif "time" in text:
        res = action_time()
    elif any(i in text for i in ["thank", "thanks", "thank you", "I appreciate it"]):
        res = np.random.choice(["you're welcome!", "anytime!", "no problem!", "absolutely!", "no worries!", "If you need anything else, just ask!"])
    else:
...
window.title("Two Buttons Example")
...
button1 = tk.Button(window, text="Vocal", command=main)
button1.pack()

# Create Button 2
button2 = tk.Button(window, text="Face", command=FaceReg)
button2.pack()
